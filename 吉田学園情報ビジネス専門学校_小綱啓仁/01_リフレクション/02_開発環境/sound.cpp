...
{// 各音素材のパラメータ
	...
	{ "data/SOUND/BGM/ranking.wav", -1 },	// ランキング
	{ "data/SOUND/SE/enter.wav", 0 },		// 決定音
	{ "data/SOUND/SE/select.wav", 0 },		// 選択音
	{ "data/SOUND/SE/snowboard.wav", 0 },	// 曲がるとき
	{ "data/SOUND/SE/get_item.wav", 0 },	// アイテム取得
	{ "data/SOUND/SE/goal.wav", 0 },		// ゴール
	{ "data/SOUND/SE/death.wav", 0 },		// 死亡
	{ "data/SOUND/SE/wall_hit.wav", 0 },	// 壁Het
};
